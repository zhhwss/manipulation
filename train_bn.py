...
def main():
    ...
    output_dir = os.path.join('result', f"best_of_n_{timestamp}")
    ...
    for epoch in range(args.num_epochs):
        # Train
        train_loss, train_head_stats, train_head_info = train_epoch(model, train_loader, criterion, optimizer, device)
