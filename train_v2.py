...
from model.model import RobotGraspModel_v2, RobotGraspModel_v2
...
def main():
    ...
    image_shape = determine_image_size(
        args.data_dir, args.image_type, args.image_scale
    )
    
    # Create data loaders
    print("Creating data loaders...")
    train_loader, val_loader, full_dataset = create_data_loaders(
        args.data_dir, args.image_type, args.image_scale, args.output_type, args.action_chunk, args.action_stride,
